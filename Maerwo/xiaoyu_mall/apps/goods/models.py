...
from xiaoyu_mall.utils.models import BaseModel, get_goods_image_upload_filename
...
class SPU(BaseModel):
    ...
    desc_pack = RichTextUploadingField(default='', verbose_name='包装信息')
...
class SKU(BaseModel):
    ...
    default_image = models.ImageField(upload_to=get_goods_image_upload_filename, max_length=200, default='', null=True, blank=True, verbose_name='默认图片')
